            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            {!! Form::open(array('url' => URL::to('admin/brand/'.$record->id), 'method' => 'PUT', 'class'=>"form-horizontal form-label-left",'id'=>'frmEditBrand','files'=> true,'autocomplete'=>false)) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        @if($record->image != 0)
                                            <img src="{{ asset('uploads/brand/'.$record->image) }}" width="100" style="margin-top: 10px;" />
                                        @endif
